...
def bonus_report_repfr(subj, scores, bonuses, nans_blank=True):
    """
    ...
    outfile = '/data/eeg/scalp/ltp/ltpRepFR/bonus/%s_bonus_report.tsv' % subj
    ...
    tex_outfile = '/data/eeg/scalp/ltp/ltpRepFR/bonus/%s_bonus_report' % subj
