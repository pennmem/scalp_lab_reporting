...
def bonus_report_courier(subj, scores, bonuses, exp, nans_blank=True):
    """
    ...
    outfile = '/data/eeg/scalp/ltp/%s/bonus/%s_bonus_report.tsv' % (exp, subj)
    ...
    if subj not in ('LTP356', 'LTP392', 'LTP400', 'LTP400', 'LTP401', 'LTP402', 'LTP404'):
        ...
        # Fill in report
        report = 'Session\tRecall Percentage\tTrial Bonus\tBlink Rate\tBlink Bonus\tTotal\n'
    ...
    tex_outfile = '/data/eeg/scalp/ltp/%s/bonus/%s_bonus_report' % (exp, subj)
