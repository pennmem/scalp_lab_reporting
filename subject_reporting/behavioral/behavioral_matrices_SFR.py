...
def make_data_matrices_SFR(subj):
    """
    ...
    out_dir = '/data/eeg/scalp/ltp/SFR/behavioral/data/'
    list_length = 12
    n_lists = 25  # Currently going to ignore the practice list
    n_sess = 2
