...
def eeg_ltpFR2(subj):
    ...
    fz_chans = ['C12', 'C13', 'C20', 'C21', 'C25', 'C26'] if int(subj[-3:]) > 330 else ['E11']  # Fz channels
    cz_chans = ['A1', 'A2', 'B1', 'C1', 'D1', 'D15'] if int(subj[-3:]) > 330 else ['E55']  # Cz channels
    pz_chans = ['A5', 'A18', 'A19', 'A20', 'A31', 'A32'] if int(subj[-3:]) > 330 else ['E62']  # Pz channels
